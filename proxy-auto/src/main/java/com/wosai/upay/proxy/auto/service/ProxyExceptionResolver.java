...
public class ProxyExceptionResolver extends DefaultExceptionResolver {
	
	private static final Logger LOGGER = Logger.getLogger(ProxyExceptionResolver.class.getName());
